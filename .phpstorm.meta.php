...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/srtfisher/sites/wp-repl/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/srtfisher/sites/wp-repl/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'session.http_only','session.same_site','session.partitioned','honeypot.enabled','honeypot.name_field_name',
...
'honeypot.honeypot_fields_required_for_all_forms','honeypot.spam_protection','honeypot.with_csp','ide-helper.filename','ide-helper.models_filename',
...
'app','honeypot::honeypotFormFields','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
