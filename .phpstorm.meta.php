...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/srtfisher/broadway/www/wp-repl/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/srtfisher/broadway/www/wp-repl/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'cors.max_age','cors.supports_credentials','backup.backup.name','backup.backup.source.files.include','backup.backup.source.files.exclude',
...
'backup.cleanup.tries','backup.cleanup.retry_delay','honeypot.enabled','honeypot.name_field_name','honeypot.randomize_name_field_name',
...
'honeypot.spam_protection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'app','honeypot::honeypotFormFields','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403',
...
'validation.uuid','validation.custom.attribute-name.rule-name','backup::notifications.exception_message','backup::notifications.exception_trace','backup::notifications.exception_message_title',
